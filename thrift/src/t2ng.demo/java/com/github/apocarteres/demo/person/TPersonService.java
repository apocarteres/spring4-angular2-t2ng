...
public class TPersonService {
  ...
  public interface Iface {
    ...
    public TPerson find(TPersonLookupRequest request) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void find(TPersonLookupRequest request, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_find(TPersonLookupRequest request) throws org.apache.thrift.TException
    {
    ...
    public TPerson recv_find() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void find(TPersonLookupRequest request, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      find_call method_call = new find_call(request, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class find_call extends org.apache.thrift.async.TAsyncMethodCall {
      private TPersonLookupRequest request;
      public find_call(TPersonLookupRequest request, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class find<I extends Iface> extends org.apache.thrift.ProcessFunction<I, find_args> {
      ...
      public find_result getResult(I iface, find_args args) throws org.apache.thrift.TException {
        find_result result = new find_result();
        result.success = iface.find(args.request);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class find<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, find_args, TPerson> {
      public find() {
        super("find");
      }
      ...
      public void start(I iface, find_args args, org.apache.thrift.async.AsyncMethodCallback<TPerson> resultHandler) throws TException {
        iface.find(args.request,resultHandler);
      }
    }
  ...
  public static class find_args implements org.apache.thrift.TBase<find_args, find_args._Fields>, java.io.Serializable, Cloneable, Comparable<find_args>   {
    ...
    private TPersonLookupRequest request; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.REQUEST, new org.apache.thrift.meta_data.FieldMetaData("request", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TPersonLookupRequest.class)));
    ...
    public find_args(find_args other) {
      if (other.isSetRequest()) {
        this.request = new TPersonLookupRequest(other.request);
      }
    }
    ...
    public TPersonLookupRequest getRequest() {
      return this.request;
    }

    public void setRequest(TPersonLookupRequest request) {
      this.request = request;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case REQUEST:
        if (value == null) {
          ...
          setRequest((TPersonLookupRequest)value);
        }
        break;
          ...
          switch (schemeField.id) {
            case 1: // REQUEST
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.request = new TPersonLookupRequest();
  ...
  public static class find_result implements org.apache.thrift.TBase<find_result, find_result._Fields>, java.io.Serializable, Cloneable, Comparable<find_result>   {
    ...
    private TPerson success; // required
    ...
    public void setSuccess(TPerson success) {
      this.success = success;
    }
